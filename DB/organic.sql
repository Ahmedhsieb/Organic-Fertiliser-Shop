...
--
-- Host: 127.0.0.2    Database: organic
-- ------------------------------------------------------
...
CREATE TABLE `order` (
  ...
  `paymentid` int NOT NULL DEFAULT '1',
...
INSERT INTO `payment` VALUES (1,'cash'),(2,'vodafone cash'),(3,'visa');
...
CREATE TABLE `product` (
  ...
  `productdesc` varchar(255) COLLATE utf8mb4_general_ci NOT NULL,
...
INSERT INTO `state` VALUES (1,'In Progress'),(2,'Cancelled'),(3,'Delivered');
...
INSERT INTO `user` VALUES (1,'a@a.com','010101010101','12345','Ahmed','Osama',1);
...
-- Dump completed on 2024-03-15 19:58:27
